        ...
        <div className="w-full lg:w-1/2 flex flex-col items-center justify-center p-10">
          ...
          <div className="w-full grid grid-cols-2 gap-3 mb-6">
            <div className="bg-blue-50 border border-blue-100 rounded-xl p-3 text-center">
              ...
              <p className="text-xs text-blue-500 mt-0.5">admin@attendx.com</p>
              <p className="text-xs text-blue-400">admin123</p>
            </div>
            <div className="bg-green-50 border border-green-100 rounded-xl p-3 text-center">
              <p className="text-xs font-semibold text-green-700">Student</p>
              <p className="text-xs text-green-500 mt-0.5">kasun.perera@student.attendx.lk</p>
              <p className="text-xs text-green-400">kasun.perera</p>
            </div>
          </div>
